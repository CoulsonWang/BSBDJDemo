//
//  BDJEssenceCollectionViewCell.m
//  BSBDJProject
//
...
@interface BDJEssenceCollectionViewCell () <UITableViewDelegate,UITableViewDataSource>
...
@implementation BDJEssenceCollectionViewCell
...
- (void)setTopicType:(BDJTopicType)topicType {

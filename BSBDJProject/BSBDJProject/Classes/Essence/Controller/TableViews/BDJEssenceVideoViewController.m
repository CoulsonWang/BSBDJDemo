//
//  BDJEssenceVideoViewController.m
//  BSBDJProject
//
...
@interface BDJEssenceVideoViewController ()

@end

@implementation BDJEssenceVideoViewController
...
- (void)refreshData {
    ...
    NSDictionary *params = @{
                             @"a" : @"list",
                             @"c" : @"data",
                             @"type" : [NSNumber numberWithUnsignedInteger:BDJTopicTypeVideo]
                             };
